	var shop_name = "Odelia"; // NAMA TOKO ONLINE
	var domain = "http://odeliafashion.com/mobile/"; // DOMAIN URL ADMIN
	var admin_url = domain;
	
	var base_url = domain+"_api_/android"; // URL API
	var base_url_media = admin_url+"media"; // DIREKTORI PENYIMPANAN IMAGE DI HOSTING
	var dir_image = "Pictures/Odelia"; // DIREKTORI PENYIMPANAN IMAGE DI SD CARD
	var token = "7950e152beccbfea406b0c33f97decf5"; // ISI DENGAN TOKEN 
