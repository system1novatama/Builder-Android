	...
	var shop_name = "Gerobak Ummi"; // NAMA TOKO ONLINE
	var domain = "http://gerobakummi.com/mobile/"; // DOMAIN URL ADMIN
	var admin_url = domain;
	
	var base_url = domain+"_api_/android"; // URL API
	var base_url_media = admin_url+"media"; // DIREKTORI PENYIMPANAN IMAGE DI HOSTING
	var dir_image = "Pictures/GerobakUmmi"; // DIREKTORI PENYIMPANAN IMAGE DI SD CARD
	var token = "c7b21bdb6c77029118239b3ba6e01d05"; // ISI DENGAN TOKEN 
