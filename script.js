	...
	var shop_name = "YES FASHION"; // NAMA TOKO ONLINE
	var domain = "http://yesfashion-olshop.toko-mobile.com/mobile/"; // DOMAIN URL ADMIN
	var admin_url = domain;
	
	var base_url = domain+"_api_/android"; // URL API
	var base_url_media = admin_url+"media"; // DIREKTORI PENYIMPANAN IMAGE DI HOSTING
	var dir_image = "Pictures/YESFASHION"; // DIREKTORI PENYIMPANAN IMAGE DI SD CARD
	var token = "675939019c5177f0d269ad85bae8bf98"; // ISI DENGAN TOKEN 
