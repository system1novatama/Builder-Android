	...
	var shop_name = "Lucky jaya collection"; // NAMA TOKO ONLINE
	var domain = "http://lucky-jaya-collection.com/mobile/"; // DOMAIN URL ADMIN
	var admin_url = domain;
	
	var base_url = domain+"_api_/android"; // URL API
	var base_url_media = admin_url+"media"; // DIREKTORI PENYIMPANAN IMAGE DI HOSTING
	var dir_image = "Pictures/Lucky-Jaya-Collection"; // DIREKTORI PENYIMPANAN IMAGE DI SD CARD
	var token = "eb22589fe83450b57ac15608a9894845"; // ISI DENGAN TOKEN 
